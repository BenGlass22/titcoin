...
contract MyToken5 is ERC20 {
    
    string private myTokenName = 'TitCoin'; // 1. The name of your of your Token
    string private myTokenSymbol = 'TIT'; // 2. A 3-letter symbol, like a stock symbol
